/*
    16.01) Crie um programa que leia um número indeterminado de vezes 3 valores (a, b, c) do tipo float. Escreva a função somaValores que recebe estes 3 valores float e imprime a soma do quadrado do 1º valor juntamente com a soma dos outros dois.
